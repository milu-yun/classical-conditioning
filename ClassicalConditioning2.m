function varargout = ClassicalConditioning2(varargin)
%CLASSICALCONDITIONING2 M-file for ClassicalConditioning2.fig
%for 4 cue reversal
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ClassicalConditioning2_OpeningFcn, ...
                   'gui_OutputFcn',  @ClassicalConditioning2_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before ClassicalConditioning2 is made visible.
function ClassicalConditioning2_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = ClassicalConditioning2_OutputFcn(hObject, eventdata, handles)
