function varargout = ClassicalConditioning_Rwprob(varargin)
% CLASSICALCONDITIONING_RWPROB MATLAB code for ClassicalConditioning_Rwprob.fig
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ClassicalConditioning_Rwprob_OpeningFcn, ...
                   'gui_OutputFcn',  @ClassicalConditioning_Rwprob_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function ClassicalConditioning_Rwprob_OpeningFcn(hObject, eventdata, handles, varargin)
...
handles.timer = timer(...
    ...
    'BusyMode', 'drop', ...
    'Period', 0.1, ...
    'TimerFcn', {@ArduinoDataReader_Rwprob,hObject});
...
function varargout = ClassicalConditioning_Rwprob_OutputFcn(hObject, eventdata, handles) 
...
rewardProb3 = get(handles.prob3, 'String');
rewardProb = [str2num(rewardProb1),str2num(rewardProb2),str2num(rewardProb3)];
