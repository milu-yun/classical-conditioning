function varargout = ClassicalConditioning3(varargin)
%CLASSICALCONDITIONING3 M-file for ClassicalConditioning3.fig
%for 4 cue reversal
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ClassicalConditioning3_OpeningFcn, ...
                   'gui_OutputFcn',  @ClassicalConditioning3_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before ClassicalConditioning3 is made visible.
function ClassicalConditioning3_OpeningFcn(hObject, eventdata, handles, varargin)
...
handles.timer = timer(...
    ...
    'BusyMode', 'drop', ...
    'Period', 0.1, ...
    'TimerFcn', {@ArduinoDataReader3,hObject});
...
function varargout = ClassicalConditioning3_OutputFcn(hObject, eventdata, handles)
