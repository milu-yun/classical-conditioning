function varargout = ClassicalConditioning_eye(varargin)
% CLASSICALCONDITIONING_EYE MATLAB code for ClassicalConditioning_eye.fig
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ClassicalConditioning_eye_OpeningFcn, ...
                   'gui_OutputFcn',  @ClassicalConditioning_eye_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function ClassicalConditioning_eye_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = ClassicalConditioning_eye_OutputFcn(hObject, eventdata, handles) 
...
set(handles.aRaster,'TickDir','out','FontSize',8, ...
    'XLim',[0 5+delayDuration+ITI],'XTIck',[0 0.5 1.5 1.5+0.0001+delayDuration 5+delayDuration+ITI],...
    'YLim',[0 10],'YTick',0:10,'YTickLabel',{0,[],[],[],[],[],[],[],[],[],10});
xlabel(handles.aRaster,'Time (s)');
ylabel(handles.aRaster,'Trial');
...
handles.data.evTime = [];
handles.data.setting = [PnDuration, ITI+2.5, rewardProb];

% Start reading serial
fprintf(handles.arduino, '%s', ['t', num2str(nTrial)]);
pause(0.25);
fprintf(handles.arduino, '%s', ['o6']);
pause(0.25);
